...
def categorize_dish(dish_name, dish_ingredients):
    ...
    categories = {'VEGAN': VEGAN, "VEGETARIAN":VEGETARIAN,
                "KETO":KETO, "PALEO":PALEO,"OMNIVORE": OMNIVORE,
            "ALCOHOLS":ALCOHOLS}
...
def tag_special_ingredients(dish):
    ...
    dish_special_ings = set(dish[1]) & SPECIAL_INGREDIENTS
    return dish[0], dish_special_ings
...
def singleton_ingredients(dishes, intersection):
    ...
    return {
        ...
        if (sum(ingredient in dish for dish in dishes) == 1)
    }
